...
public class LiteralsSimilaritySwitch extends LiteralsSwitch<Boolean> {
    ...
    public Boolean caseBooleanLiteral(BooleanLiteral boolean1) {
        BooleanLiteral boolean2 = (BooleanLiteral) this.similaritySwitch.getCompareElement();
        return (boolean1.isValue() == boolean2.isValue());
    }

    @Override
    public Boolean caseCharacterLiteral(CharacterLiteral char1) {
        CharacterLiteral char2 = (CharacterLiteral) this.similaritySwitch.getCompareElement();
        return char1.getValue().equals(char2.getValue());
    }

    @Override
    public Boolean caseDecimalFloatLiteral(DecimalFloatLiteral float1) {
        DecimalFloatLiteral float2 = (DecimalFloatLiteral) this.similaritySwitch.getCompareElement();
    ...
    public Boolean caseHexFloatLiteral(HexFloatLiteral float1) {
        HexFloatLiteral float2 = (HexFloatLiteral) this.similaritySwitch.getCompareElement();
    ...
    public Boolean caseDecimalDoubleLiteral(DecimalDoubleLiteral double1) {
        DecimalDoubleLiteral double2 = (DecimalDoubleLiteral) this.similaritySwitch.getCompareElement();
    ...
    public Boolean caseHexDoubleLiteral(HexDoubleLiteral double1) {
        HexDoubleLiteral double2 = (HexDoubleLiteral) this.similaritySwitch.getCompareElement();
