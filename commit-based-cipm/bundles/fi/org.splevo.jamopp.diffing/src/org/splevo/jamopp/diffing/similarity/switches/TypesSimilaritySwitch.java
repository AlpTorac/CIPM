...
public class TypesSimilaritySwitch extends TypesSwitch<Boolean> {
    ...
    public Boolean caseClassifierReference(ClassifierReference ref1) {
        ClassifierReference ref2 = (ClassifierReference) this.similaritySwitch.getCompareElement();
    ...
    public Boolean caseTypeReference(TypeReference ref1) {
        ...
        TypeReference ref2 = (TypeReference) this.similaritySwitch.getCompareElement();
    ...
    public Boolean caseNamespaceClassifierReference(NamespaceClassifierReference ref1) {
        ...
        NamespaceClassifierReference ref2 = (NamespaceClassifierReference) this.similaritySwitch.getCompareElement();
        ...
        return this.similaritySwitch.isSimilar(pureRef1, pureRef2);
    }
