...
public class SimilaritySwitch extends ComposedSwitch<Boolean> {
    ...
    static final class SSLoggingHelper {
    	...
    	static void setLogger(Logger logger) {
    		ssLogger = logger;
    		ssLogger.debug("SimilaritySwitch logger set");
    	}
    	...
    	static void logComparison(String subject1, String subject2) {
    		ssLogger.debug("Comparing " + getComparisonSubjectType() + "s (1 vs 2): " +
        			Strings.nullToEmpty(subject1) + " vs " + Strings.nullToEmpty(subject2));
        }
        
    	static void logResult(boolean result) {
    		ssLogger.debug(getComparisonSubjectType() + "s similar: " + result);
        }
    	
    	static void logMessage(String msg) {
    		ssLogger.debug(msg + " (while comparing" + getComparisonSubjectType() + ")");
    	}
    }
