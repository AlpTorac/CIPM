...
/**
 * This class is responsible for controlling the complete change propagation and
 ...
 * @author Lukas Burgey
 */
public abstract class CommitIntegrationController<CM extends ModelFacade> {
	...
	private Optional<Propagation> propagateCurrentCheckout() {
		...
		var resource = state.getCodeModelFacade().parseModel(workTree).getResources().get(0);
		if (resource == null) {
