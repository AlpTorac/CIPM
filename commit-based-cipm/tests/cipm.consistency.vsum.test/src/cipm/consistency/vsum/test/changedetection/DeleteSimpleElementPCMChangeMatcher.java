...
public class DeleteSimpleElementPCMChangeMatcher implements ICompositeChangeMatcher {
	private List<EChange> changeSeq;

	private SubtractiveReferenceEChange sr;
	private DeleteEObject dc;

	public DeleteSimpleElementPCMChangeMatcher(EChange sr, List<EChange> changeSeq) {
