...
public class TeaStoreRepoSettings implements HasRepoSettings {
	...
	/**
	 * Copies the exec-files required to skip UI prompts during test runs
	 * into all "java" directories under the given target directory path.
	 * 
	 ...
	 * @param copyToPath Path to the directory, where the files will be copied into
	 */
	...
	/**
	 * Creates the TestGroup directory under the given target/TestGroup directory path. 
	 * Creates all necessary directories along the way, if needed and possible.
	 * 
