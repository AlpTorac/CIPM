...
public class DataTypeWithMultipleExistingClassifiersTest extends PCMJavaCPRTest {
	@Override
	protected Path getTestRootDirName() {
		return Path.of("pcmjava-testmodels", "datatype", "withMultipleExistingClassifiers");
	}
