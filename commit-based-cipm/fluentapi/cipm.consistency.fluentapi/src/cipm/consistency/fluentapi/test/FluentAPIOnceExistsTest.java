...
public class FluentAPIOnceExistsTest {
	...
	public void multipleMarkOnceExistsTest() {
		...
		// construction
		var implCls = api
				.onceExists(FluentAPITestUtils.toEList(ifcOneName, ifcTwoName), (Runnable) () -> api.newClass()
						.withName(implementingClsName)
	...
	public void multipleOnceExistsForSameMarkTest() {
		...
		var cls =
				...
				api.newClassMethod().withName(met1Name).markCurrent(met1Name).toAPI().onceExists(clsName,
						(Runnable) () -> api.modifyMarkedClassMethod(met1Name).withTypeReference(
						...
						.onceExists(clsName,
								(Runnable) () -> api.modifyMarkedClassMethod(met2Name)
	...
	public void multipleOnceExistsForSameMarksTest() {
		...
		var cls =
				...
				api.newClassMethod().withName(met1Name).markCurrent(met1Name).toAPI().onceExists(
						...
						(Runnable) () -> api.modifyMarkedClassMethod(met1Name)
						...
						// met2
						.newClassMethod().withName(met2Name).markCurrent(met2Name).toAPI()
						.onceExists(FluentAPITestUtils.toEList(clsName, paramClsName), (Runnable) () -> api
