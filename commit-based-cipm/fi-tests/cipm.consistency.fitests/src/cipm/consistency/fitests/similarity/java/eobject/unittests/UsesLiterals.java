...
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.BinaryIntegerLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.BinaryLongLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.BooleanLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.CharacterLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.DecimalDoubleLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.DecimalFloatLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.DecimalIntegerLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.DecimalLongLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.HexDoubleLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.HexFloatLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.HexIntegerLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.HexLongLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.NullLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.OctalIntegerLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.OctalLongLiteralInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.SuperInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.literals.ThisInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.modifiers.StaticInitialiser;
import cipm.consistency.fitests.similarity.java.eobject.initialiser.modifiers.TransitiveInitialiser;
