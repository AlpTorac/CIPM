...
import cipm.consistency.initialisers.emftext.expressions.ShiftExpressionInitialiser;

public class ShiftExpressionTest extends AbstractEMFTextSimilarityTest implements UsesExpressions {
