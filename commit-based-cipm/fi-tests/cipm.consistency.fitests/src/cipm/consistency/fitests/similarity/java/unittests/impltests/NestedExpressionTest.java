...
public class NestedExpressionTest extends EObjectSimilarityTest
	implements UsesExpressions {
	...
	public void testExpression() {
		...
		this.testX(objOne, objTwo, ExpressionsPackage.Literals.NESTED_EXPRESSION__EXPRESSION);
	}
}
