...
import cipm.consistency.fitests.similarity.eobject.initialiser.java.references.IElementReferenceInitialiser;
...
public class ElementReferenceTestParams implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext arg0) throws Exception {
		return new EObjectJavaInitialiserParameters().getAllInitialisersBySuper(IElementReferenceInitialiser.class).stream()
