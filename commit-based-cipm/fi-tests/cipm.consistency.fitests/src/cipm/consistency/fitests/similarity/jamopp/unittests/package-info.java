 ...
 * not. These test methods ensure that no exceptions are thrown while performing
 * similarity checking on EObject instances that are not initialised properly.
 * </ul>
