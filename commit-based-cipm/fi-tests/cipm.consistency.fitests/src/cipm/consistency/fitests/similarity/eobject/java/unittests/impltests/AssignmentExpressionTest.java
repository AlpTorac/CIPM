...
import cipm.consistency.fitests.similarity.eobject.initialiser.java.expressions.AssignmentExpressionInitialiser;
import cipm.consistency.fitests.similarity.eobject.java.unittests.UsesExpressions;

public class AssignmentExpressionTest extends AbstractEObjectJavaSimilarityTest implements UsesExpressions {
