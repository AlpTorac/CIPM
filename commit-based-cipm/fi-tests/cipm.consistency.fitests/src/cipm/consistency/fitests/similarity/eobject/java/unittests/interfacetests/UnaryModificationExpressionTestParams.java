...
import cipm.consistency.initialisers.eobject.java.expressions.IUnaryModificationExpressionInitialiser;
...
public class UnaryModificationExpressionTestParams implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext arg0) throws Exception {
		return new EObjectJavaInitialiserParameters().getAllInitialisersBySuper(IUnaryModificationExpressionInitialiser.class)
