...
import cipm.consistency.initialisers.emftext.expressions.ConditionalExpressionInitialiser;

public class ConditionalExpressionTest extends AbstractEMFTextSimilarityTest implements UsesExpressions {
