...
public class AnnotationInstanceTest extends AbstractJaMoPPSimilarityImplTest
	...
	@TestFactory
	public Collection<DynamicNode> testAnnotation() {
		var currentState = this.initElement(this.createMinimalClass("cls1"), null);
		var newState = this.initElement(this.createMinimalClass("cls2"), null);

		return this.generateTestsFor(currentState, newState,
				AnnotationsPackage.Literals.ANNOTATION_INSTANCE__ANNOTATION,
				List.of(this.createReferenceChange(newState, null, DifferenceKind.CHANGE,
						AnnotationsPackage.Literals.ANNOTATION_INSTANCE__ANNOTATION),
						this.createReferenceChange(null, currentState, DifferenceKind.CHANGE,
								AnnotationsPackage.Literals.ANNOTATION_INSTANCE__ANNOTATION)));
	}
