...
import cipm.consistency.fitests.similarity.java.eobject.initialiser.imports.IImportingElementInitialiser;
...
public class ImportingElementTestParams implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext arg0) throws Exception {
		return new EObjectInitialiserParameters().getAllInitialisersBySuper(IImportingElementInitialiser.class).stream()
