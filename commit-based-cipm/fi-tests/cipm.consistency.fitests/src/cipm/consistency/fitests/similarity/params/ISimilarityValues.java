...
public interface ISimilarityValues {
	...
	/**
	 * Overrides the expected similarity result for the (objCls, attr) pair by
	 * removing and re-adding the said pair with the given expectedSimResult.
	 * 
	 * @see {@link #getExpectedSimilarityResult(Class, Object)} for more information
	 *      on expected similarity checking result.
	 * 
	 * @see {@link #addSimilarityEntry(Class, Object, Boolean)}
	 */
//	public default void replaceSimilarityEntry(Class<?> objCls, Object attr, Boolean expectedSimResult) {
//		this.removeSimilarityEntry(objCls, attr);
//		this.addSimilarityEntry(objCls, attr, expectedSimResult);
//	}
