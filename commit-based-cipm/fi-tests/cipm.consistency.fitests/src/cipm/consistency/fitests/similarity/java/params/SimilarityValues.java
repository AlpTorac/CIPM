...
public class SimilarityValues extends AbstractSimilarityValues {
	public SimilarityValues() {
		/*
		 * Below are the expected similarity values for tests, in which
		 * a certain attribute is different.
		 * 
		 * Keep in mind that entries for specific classes will take precedence over
		 * more general entries. Same goes for entries for super classes/interfaces as well.
		 * 
		...
		// Arrays
 		...
 		this.addSimilarityEntry(EmptyModel.class, CommonsPackage.Literals.NAMESPACE_AWARE_ELEMENT__NAMESPACES, Boolean.TRUE);
		...
		// Modifiers
		this.addSimilarityEntry(ModifiersPackage.Literals.ANNOTABLE_AND_MODIFIABLE__ANNOTATIONS_AND_MODIFIERS, Boolean.TRUE);
		...
		this.addSimilarityEntry(ModulesPackage.Literals.ACCESS_PROVIDING_MODULE_DIRECTIVE__ACCESSABLE_PACKAGE, Boolean.TRUE);
		...
		this.addSimilarityEntry(ExplicitlyTypedLambdaParameters.class, ParametersPackage.Literals.PARAMETRIZABLE__PARAMETERS, Boolean.TRUE);
		this.addSimilarityEntry(ImplicitlyTypedLambdaParameters.class, ParametersPackage.Literals.PARAMETRIZABLE__PARAMETERS, Boolean.TRUE);
		this.addSimilarityEntry(SingleImplicitLambdaParameter.class, ParametersPackage.Literals.PARAMETRIZABLE__PARAMETERS, Boolean.TRUE);
		...
		this.addSimilarityEntry(InstanceOfExpression.class, TypesPackage.Literals.TYPED_ELEMENT__TYPE_REFERENCE, Boolean.FALSE);
		this.addSimilarityEntry(QualifiedTypeArgument.class, TypesPackage.Literals.TYPED_ELEMENT__TYPE_REFERENCE, Boolean.FALSE);
		this.addSimilarityEntry(NewConstructorCall.class, TypesPackage.Literals.TYPED_ELEMENT__TYPE_REFERENCE, Boolean.FALSE);
		this.addSimilarityEntry(NewConstructorCallWithInferredTypeArguments.class, TypesPackage.Literals.TYPED_ELEMENT__TYPE_REFERENCE, Boolean.FALSE);
		this.addSimilarityEntry(ProvidesModuleDirective.class, TypesPackage.Literals.TYPED_ELEMENT__TYPE_REFERENCE, Boolean.FALSE);
		this.addSimilarityEntry(UsesModuleDirective.class, TypesPackage.Literals.TYPED_ELEMENT__TYPE_REFERENCE, Boolean.FALSE);
