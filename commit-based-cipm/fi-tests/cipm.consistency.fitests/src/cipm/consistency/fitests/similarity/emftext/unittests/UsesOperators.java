...
import cipm.consistency.initialisers.emftext.operators.AdditionInitialiser;
import cipm.consistency.initialisers.emftext.operators.AssignmentInitialiser;
import cipm.consistency.initialisers.emftext.operators.AssignmentOrInitialiser;
import cipm.consistency.initialisers.emftext.operators.DivisionInitialiser;
import cipm.consistency.initialisers.emftext.operators.EqualInitialiser;
import cipm.consistency.initialisers.emftext.operators.GreaterThanInitialiser;
import cipm.consistency.initialisers.emftext.operators.LeftShiftInitialiser;
import cipm.consistency.initialisers.emftext.operators.LessThanInitialiser;
import cipm.consistency.initialisers.emftext.operators.MinusMinusInitialiser;
import cipm.consistency.initialisers.emftext.operators.MultiplicationInitialiser;
import cipm.consistency.initialisers.emftext.operators.NotEqualInitialiser;
import cipm.consistency.initialisers.emftext.operators.PlusPlusInitialiser;
import cipm.consistency.initialisers.emftext.operators.RightShiftInitialiser;
import cipm.consistency.initialisers.emftext.operators.SubtractionInitialiser;
