...
import cipm.consistency.fitests.similarity.emftext.unittests.UsesSwitchCases;
import cipm.consistency.initialisers.emftext.statements.SwitchInitialiser;

public class SwitchTest extends AbstractEMFTextSimilarityTest implements UsesSwitchCases {
