 ...
 * implemented to access initialiser interfaces and classes easier. <br>
 * <br>
 ...
 * define atomic modification methods in initialisers and reusing them, rather
 ...
 * {@link cipm.consistency.initialisers.IInitialiserAdapterStrategy} to augment
 * certain initialisers in ways that lets them be used in such tests without
 * throwing certain exceptions. The most common cause of such exceptions is
 * initialisers not setting any required attributes while instantiating
